...
1. kafka_2.13-3.3.1 % bin/zookeeper-server-start.sh config/zookeeper.properties
2. kafka_2.13-3.3.1 % bin/kafka-server-start.sh config/server.properties
3. kafka_2.13-3.3.1 % bin/kafka-console-producer.sh --broker-list localhost:9092 --topic NewTopic     
